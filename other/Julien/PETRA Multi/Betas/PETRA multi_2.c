/****************************************************************************************
 * PETRA MULTIPIECE avec TIME-OUTs et/ou ARRET D'URGENCE
 * Circulation multiprocessus et multipieces sur le PETRA avec un mecanisme de TIME-OUT
 ***************************************************************************************/
...
//Handler execute par un thread piece a la reception d'un SIGCHLD
